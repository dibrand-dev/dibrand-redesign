            ...
            <div className="container mx-auto px-6">
                <div className="max-w-7xl mx-auto rounded-[4rem] bg-zinc-900 overflow-hidden text-white flex flex-col lg:flex-row items-stretch">
                    ...
                    <div className="p-12 lg:p-20 flex flex-col justify-center lg:w-3/5 space-y-10">
                        <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-white/5 border border-white/10 text-[#D83484] text-sm font-black tracking-widest uppercase">
                            <TrendingUp size={18} />
                        ...
                        <div className="pt-8 mb-4">
                            ...
                            >
                                {cta}
                                <ArrowUpRight size={22} className="text-[#D83484] group-hover:rotate-45 transition-transform" />
                            </Link>
                        </div>
                    </div>

                    {/* Right visual/stat */}
                    <div className="lg:w-2/5 md:w-full bg-[#D83484] flex flex-col items-center justify-center p-12 text-center text-zinc-900">
