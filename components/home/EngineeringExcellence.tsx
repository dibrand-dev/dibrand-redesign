            ...
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                    {items.map((item: any, index: number) => {
                        ...
                        return (
                            <div key={index} className="flex flex-col group p-8 lg:p-12 rounded-3xl border border-zinc-100 bg-white hover:border-brand/20 transition-all duration-300 h-full">
