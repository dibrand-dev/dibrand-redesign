...
export default function HeroSection({ dict }: HeroSectionProps) {
    return (
        <section className="relative w-full h-[70vh] min-h-[600px] overflow-hidden flex flex-col">
            ...
            <div className="relative z-20 container mx-auto px-6 flex-grow flex flex-col items-center justify-center text-center pt-28 pb-32 md:pb-40">
                ...
                <div className="mt-8 md:mt-10 flex flex-col items-center w-full max-w-4xl">
                    ...
                    <div className="mt-14 md:mt-20 flex flex-wrap justify-center gap-8 md:gap-20 items-end pt-8 border-t border-white/15 w-full pb-8">
