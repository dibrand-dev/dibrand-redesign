                    ...
                    {isMounted ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {cases.slice(0, 3).map((project) => (
                                <div key={project.id} className="bg-zinc-50 border border-zinc-100 rounded-2xl overflow-hidden h-[400px] flex flex-col shadow-sm">
                                    <div className="p-6">
                                        <div className="h-4 w-24 bg-zinc-200 rounded animate-pulse mb-4" />
                                        <div className="h-8 w-full bg-zinc-200 rounded animate-pulse" />
                                    </div>
                                    <div className="mt-auto aspect-[16/10] bg-zinc-200 animate-pulse" />
                                </div>
                            ))}
                        </div>
                    )}
