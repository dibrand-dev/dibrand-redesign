        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link className="group relative flex flex-col justify-between p-8 bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1" href="#">
            <div className="flex items-start justify-between">
              ...
              <span className="p-2 rounded-full text-[#c4c6cf] group-hover:text-[#9e4d97] group-hover:bg-[#e5eeff] transition-colors">
            ...
            <div className="mt-8">
              ...
              <h3 className="text-xl font-bold text-[#00142f] group-hover:text-[#9e4d97] transition-colors mt-1">
            ...
            <div className="mt-6 pt-4 bg-[#eff4ff]/50 -mx-8 -mb-8 px-8 pb-4 rounded-b-xl flex items-center justify-between">
              ...
              <span className="text-xs font-bold text-[#9e4d97]">Solicitar turno →</span>
            </div>
          </Link>
          ...
          <Link className="group relative flex flex-col justify-between p-8 bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1" href="#">
            <div className="flex items-start justify-between">
              <div className="w-14 h-14 rounded-xl bg-[#cce5ff]/50 text-[#9e4d97] flex items-center justify-center group-hover:scale-105 transition-transform">
            ...
            <div className="mt-6 pt-4 bg-[#eff4ff]/50 -mx-8 -mb-8 px-8 pb-4 rounded-b-xl flex items-center justify-between">
              ...
              <span className="text-xs font-bold text-[#9e4d97]">Consultar boleta →</span>
            </div>
          </Link>
          ...
          <Link className="group relative flex flex-col justify-between p-8 bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1" href="#">
            ...
            <div className="mt-6 pt-4 bg-[#eff4ff]/50 -mx-8 -mb-8 px-8 pb-4 rounded-b-xl flex items-center justify-between">
              ...
              <span className="text-xs font-bold text-[#9e4d97]">Ver requisitos →</span>
            </div>
          </Link>
          ...
          <Link className="group relative flex flex-col justify-between p-8 bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1" href="#">
            ...
            <div className="mt-6 pt-4 bg-[#eff4ff]/50 -mx-8 -mb-8 px-8 pb-4 rounded-b-xl flex items-center justify-between">
              ...
              <span className="text-xs font-bold text-[#9e4d97]">Iniciar trámite →</span>
            </div>
          </Link>
          ...
          <Link className="group relative flex flex-col justify-between p-8 bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1" href="#">
            ...
            <div className="mt-6 pt-4 bg-[#eff4ff]/50 -mx-8 -mb-8 px-8 pb-4 rounded-b-xl flex items-center justify-between">
              ...
              <span className="text-xs font-bold text-[#9e4d97]">Ver puntos →</span>
            </div>
          </Link>
          ...
          <Link className="group relative flex flex-col justify-between p-8 bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1" href="#">
            ...
            <div className="mt-6 pt-4 bg-[#eff4ff]/50 -mx-8 -mb-8 px-8 pb-4 rounded-b-xl flex items-center justify-between">
              ...
              <span className="text-xs font-bold text-[#9e4d97]">Explorar guía →</span>
            </div>
          </Link>
        </div>
      </div>
